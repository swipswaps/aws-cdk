...
describe('stack', () => {
  ...
  describe('@aws-cdk/core:enableStackNameDuplicates', () => {
    ...
    describe('disabled (default)', () => {
      ...
      testFeatureFlagDisable('stack.templateFile is the name of the template file emitted to the cloud assembly (default is to use the stack name)', App, (app) => {
        // WHEN
      ...
      testFeatureFlagDisable('artifactId and templateFile use the stack name', App, (app) => {
        // WHEN
